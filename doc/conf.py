...
# -*- coding: utf-8 -*-
#
# dumpling documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'dumpling.tex', 'dumpling Documentation',
   'Zhenjiang Zech Xu', 'manual'),
]
...
man_pages = [
    (master_doc, 'dumpling', 'dumpling Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'dumpling', 'dumpling Documentation',
   author, 'dumpling', 'One line description of project.',
   'Miscellaneous'),
]
